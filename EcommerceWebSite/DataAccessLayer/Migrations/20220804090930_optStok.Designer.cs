...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220804090930_optStok")]
    partial class optStok
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.ProductOptStok", b =>
                {
                    b.Property<int>("ProductOptStokID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ProductOptStokID");

                    b.HasIndex("OptionValuesID");

                    b.HasIndex("ProductID");

                    b.ToTable("ProductOptStok");
                });
            ...
            modelBuilder.Entity("Data.Models.ProductOptStok", b =>
                {
                    b.HasOne("Data.Models.OptionValues", "OptionValues")
                        .WithMany()
